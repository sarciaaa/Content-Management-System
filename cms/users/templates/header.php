...
<body>
    <div class="dashboard d-flex justify-content-between">
        <div class="sidebar bg-dark vh-100">
            <h1 style="background-color: maroon" class="p-4"><a href="./index.php" class="text-light text-decoration-none">Dashboard</a></h1>
            <div class="menues p-4 mt-5">
                ...
                <div class="menu mt-5">
                    <a style="background-color: pink" href="logout.php" class="btn btn">Logout</a>
                </div>
